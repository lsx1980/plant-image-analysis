...
# Edge Detector
blob = cv2.dnn.blobFromImage(image, scalefactor=1.0, size=(W, H), mean=(104.00698794, 116.66876762, 122.67891434), swapRB=False, crop=False)
...
cv2.imwrite(result_file, hed)

result_file = ("/home/suxing/example/plant_test/seeds/test/canny.png")
cv2.imwrite(result_file, canny)
