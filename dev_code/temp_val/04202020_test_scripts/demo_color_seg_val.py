...
python3 demo_color_seg_val.py -p ~/temp_val/test/ -ft jpg 
...
def segmentation(image_file):
    ...
    # save Lab result
    result_file = (save_path + 'L.' + ext)
    cv2.imwrite(result_file, colors_L_gray)
    
    
    #color clustering based plant object segmentation
    thresh = color_cluster_seg(orig, args_colorspace, args_channels, args_num_clusters, min_size = 28500)
    
    masked_orig = cv2.bitwise_and(gray, gray, mask = thresh)
    
    masked_orig[thresh == 0] = 255
...
if __name__ == '__main__':
    ...
    global  template
    # local path needed!
    template_path = "/home/suxing/plant-image-analysis/marker_template/sticker_0416.jpg"
    # Read the template 
