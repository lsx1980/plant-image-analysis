...
time python3 demo_trait_extract_parallel_val.py -p ~/temp_val/test/-2021-04-16-17-24-40_crop/ -ft jpg -min 20000 -tp ~/temp_val/mark_template/0420_marker.jpg
...
def comp_external_contour(orig,thresh):
    ...
    for c in contours:
        ...
        if w>img_width*0.01 and h>img_height*0.01:
            ...
            project_val = [0.757676475925781, 0.761763598778722, 0.579364589650692, 
                            0.550715622462313, 0.618306570821603, 0.698434495790187, 
                            0.728405778796457, 0.835192753813845, 0.77798677700078]
