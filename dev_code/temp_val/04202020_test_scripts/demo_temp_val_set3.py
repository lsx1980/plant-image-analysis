...
def comp_external_contour(orig,thresh):
    ...
    for c in contours:
        ...
        if w>img_width*0.01 and h>img_height*0.01:
            ...
            project_val = [0.603672452372464, 0.554762918745659, 0.63917233919931, 
                        0.621921332342313, 0.902369316285217, 0.635848915344239, 
                        0.850622139999304, 0.639554151565586, 0.74358524649558]
